...
df = pd.read_csv('/home/jl/MSI_Theory/PAPR-MESS_calculation/NO+NO/calculation_4/nominal/T_rate_plot.csv')
df_temp = df['T']
df_raw = df['P1->P2']
...
plt.legend()
plt.savefig('Vibe_Checker_N2O+O_NO+NO.pdf',dpi=1000,bbox_inches='tight')