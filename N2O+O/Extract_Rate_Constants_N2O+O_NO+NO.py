...
lines=load_text_file('/home/jl/MSI_Theory/PAPR-MESS_calculation/NO+NO/calculation_9/nominal/'+file_name)
reaction_label, fit = pull_out_chebyshev_fit(lines,p_list,shape=(7,1))
reactions = build_reaction_string(p_list, temp_dict = {'P1':'N2O + O', 'P2':'NO + NO'})
